...
export const Footer = () => {
  return (
    <div className="w-full bottom-0  flex flex-col gap-10 px-20 pl-48 pt-10 sm:pt-10 pb-8 sm:pb-4 bg-black text-white 2xl:pl-20 xl:pl-7 sm:gap-6 sm:pl-4 sm:px-5 AcehLight">

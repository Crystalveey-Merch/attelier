  ...
  return (
    <div className=" Aceh flex flex-col gap-10 items-center p-10 xl:px-5 sm:px-0 sm:gap-5">
      <div className="flex flex-col gap-4">
        <h3 className=" text-black Aceh uppercase text-xl"> Shop Categories</h3>
      </div>
      ...
      >
        {categories.map((item, index) => {
          return (
            <SwiperSlide className="  m-auto sm:mx-0" key={index}>
              <Link to={`/category/${convertForURL(item.name)}`}>
                <div

  ...
  return (
    ...
    >
      <Helmet>
        ...
        <link
          rel=" canonical"
          href={`http://atelier.crystalveey.com/${productId}`}
        />
        ...
        <meta
          name="keywords"
          content={`ecommerce, ${product.name},online shopping, retail, products, services, atelier`}
        ></meta>
      ...
      <div className="m-20 sm:p-5 sm:m-2 w-1/2 sm:w-full rela sm:px-5  ">
        ...
        <div className="flex gap-5 my-10 sm:flex-col  sm:gap-4 text-white m-auto sm:w-full justify-center">
          <NavLink
            ...
            to={`/ordernow/${productId}`}
          >
            <button className="bg-black py-4  w-40 sm:w-full uppercase">
              Order Now{" "}
            </button>
          </NavLink>
          <button
            onClick={addToCart}
            className="uppercase border-2 border-black   py-4  text-black bg-white w-40 sm:w-full"
          >
            ADD TO CART
          </button>
        </div>
